...
public class RandomAlgorithm implements Algorithm {
	...
	/**
	 * Performs a simulation step, moving messages to the 
	 * next node and injecting new messages as required.
	 * Returns false when there is no further step to take.
	 */
	public boolean step() {
		...
		if (!network.messagesMoving() && !network.isOpen()) { return false; } 
